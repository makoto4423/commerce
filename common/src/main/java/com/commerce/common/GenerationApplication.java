...
//        gc.setFileOverride(true);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/commerce?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
//        pc.setModuleName("common");
        pc.setParent("com.commerce.common");
...
//        strategy.setSuperEntityColumns("id");
        strategy.setInclude("common_user");
